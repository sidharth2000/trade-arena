...
public class AuctionMaster {
    ...
    @Column(name = "current_approved_bid_id")
    private UUID currentApprovedBidId;

    @Column(name = "payment_failure_cycles", nullable = false)
    private Integer paymentFailureCycles = 0;
    ...
    public UUID getCurrentApprovedBidId()                        { return currentApprovedBidId; }
    public void setCurrentApprovedBidId(UUID id)                 { this.currentApprovedBidId = id; }
    public Integer getPaymentFailureCycles()                     { return paymentFailureCycles; }
    public void setPaymentFailureCycles(Integer c)               { this.paymentFailureCycles = c; }
